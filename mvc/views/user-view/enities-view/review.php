<section class="hero-area">
        ...
        <div class="hero-post-slides owl-carousel">
            ...
            <div class="single-hero-post d-flex flex-wrap">
                <!-- Post Thumbnail -->
                <div class="slide-post-thumbnail h-100 bg-img" style="background-image: url(./mvc/public/user/img/blog-img/13.jpg);">
                </div>
                <!-- Post Content -->
                <div class="slide-post-content h-100 d-flex align-items-center">
                    <div class="slide-post-text">
                        ...
                        <p class="post-excerpt" data-animation="fadeIn" data-delay="500ms">Excepteur sint occaecat
            ...
            <div class="single-hero-post d-flex flex-wrap">
                <!-- Post Thumbnail -->
                <div class="slide-post-thumbnail h-100 bg-img" style="background-image: url(./mvc/public/user/img/blog-img/14.jpg);">
                </div>
                <!-- Post Content -->
                <div class="slide-post-content h-100 d-flex align-items-center">
                    <div class="slide-post-text">
            ...
            <div class="single-hero-post d-flex flex-wrap">
                <!-- Post Thumbnail -->
                <div class="slide-post-thumbnail h-100 bg-img" style="background-image: url(./mvc/public/user/img/blog-img/15.jpg);">
                </div>
                <!-- Post Content -->
                <div class="slide-post-content h-100 d-flex align-items-center">
                    <div class="slide-post-text">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="featured-post-area mb-50">
                                    ...
                                    <div class="post-thumbnail mb-30">
                                        <a href="#"><img src="./mvc/public/user/img/blog-img/12.jpg" alt=""></a>
                                    </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-blog-post mb-50">
                                    ...
                                    <div class="post-thumbnail">
                                        <a href="#"><img src="./mvc/public/user/img/blog-img/1.jpg" alt=""></a>
                                    </div>
                                    <!-- Content -->
                                    <div class="post-content">
                                        <p class="post-date">MAY 10, 2018 / life</p>
                                        <a href="#" class="post-title">
                                            <h4>Travel Tuesday: Answering Your Most Frequent International
                                                Transportation Questions</h4>
                                        </a>
                                        <p class="post-excerpt">Excepteur sint occaecat cupidatat non proident, sunt in
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-blog-post mb-50">
                                    <!-- Thumbnail -->
                                    <div class="post-thumbnail">
                                        <a href="#"><img src="./mvc/public/user/img/blog-img/2.jpg" alt=""></a>
                                    </div>
                                    <!-- Content -->
                                    <div class="post-content">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-blog-post mb-50">
                                    <!-- Thumbnail -->
                                    <div class="post-thumbnail">
                                        <a href="#"><img src="./mvc/public/user/img/blog-img/3.jpg" alt=""></a>
                                    </div>
                                    <!-- Content -->
                                    <div class="post-content">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-blog-post mb-50">
                                    <!-- Thumbnail -->
                                    <div class="post-thumbnail">
                                        <a href="#"><img src="./mvc/public/user/img/blog-img/4.jpg" alt=""></a>
                                    </div>
                                    <!-- Content -->
                                    <div class="post-content">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-blog-post mb-50">
                                    <!-- Thumbnail -->
                                    <div class="post-thumbnail">
                                        <a href="#"><img src="./mvc/public/user/img/blog-img/5.jpg" alt=""></a>
                                    </div>
                                    <!-- Content -->
                                    <div class="post-content">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-blog-post mb-50">
                                    <!-- Thumbnail -->
                                    <div class="post-thumbnail">
                                        <a href="#"><img src="./mvc/public/user/img/blog-img/6.jpg" alt=""></a>
                                    </div>
                                    <!-- Content -->
                                    <div class="post-content">
                    ...
                    <div class="post-sidebar-area">
                        ...
                        <div class="single-widget-area mb-30">
                            ...
                            <div class="about-thumbnail">
                                <img src="./mvc/public/user/img/blog-img/about-me.jpg" alt="">
                            </div>
                            <!-- Content -->
                            <div class="widget-content text-center">
                                <img src="./mvc/public/user/img/core-img/signature.png" alt="">
                        ...
                        <div class="single-widget-area mb-30">
                            ...
                            <div class="single-latest-post d-flex">
                                <div class="post-thumb">
                                    <img src="./mvc/public/user/img/blog-img/lp1.jpg" alt="">
                                </div>
                                <div class="post-content">
                                    <a href="#" class="post-title">
                            ...
                            <div class="single-latest-post d-flex">
                                <div class="post-thumb">
                                    <img src="./mvc/public/user/img/blog-img/lp2.jpg" alt="">
                                </div>
                                <div class="post-content">
                                    <a href="#" class="post-title">
                            ...
                            <div class="single-latest-post d-flex">
                                <div class="post-thumb">
                                    <img src="./mvc/public/user/img/blog-img/lp3.jpg" alt="">
                                </div>
                                <div class="post-content">
                                    <a href="#" class="post-title">
                            ...
                            <div class="single-latest-post d-flex">
                                <div class="post-thumb">
                                    <img src="./mvc/public/user/img/blog-img/lp4.jpg" alt="">
                                </div>
                                <div class="post-content">
                                    <a href="#" class="post-title">
                            ...
                            <div class="single-latest-post d-flex">
                                <div class="post-thumb">
                                    <img src="./mvc/public/user/img/blog-img/lp5.jpg" alt="">
                                </div>
                                <div class="post-content">
                                    <a href="#" class="post-title">
                        ...
                        <div class="single-widget-area mb-30">
                            <!-- Adds -->
                            <a href="#"><img src="./mvc/public/user/img/blog-img/add.png" alt=""></a>
                        </div>
