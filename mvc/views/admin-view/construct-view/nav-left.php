  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item">
      <a href="javascript:void(0);" class="menu-link menu-toggle">
        ...
        <div data-i18n="Layouts">Quản lý các món ăn</div>
      </a>

      <ul class="menu-sub">
        <li class="menu-item">
          <a href="admin/categoryfood" class="menu-link">
            <div data-i18n="Without menu">Quản lý danh mục các món</div>
          </a>
        </li>
        <li class="menu-item">
          <a href="admin/food" class="menu-link">
            <div data-i18n="Without menu">Quản lý các món</div>
          </a>
        </li>
